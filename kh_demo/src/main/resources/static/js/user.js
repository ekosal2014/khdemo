	    ...
	    beforeSend: function(xhr) {
			...
			if (userList.length > 0){
				...
				$.each(userList,function(index,value){
					...
					tbl +=	'         <a href="javascript:" data-id="'+value.user_id+'" onClick="deleteUserInformation(this);" style="width:25%;margin:0px;text-decoration: underline;text-align:center;color:blue;">លុប</a>|'
					tbl +=	'         <a href="permission-setting/'+parseInt(value.user_id)+'" data-id="'+value.user_id+'" /*onClick="setPermissionUser(this)"*/  style="width:30%;margin:0px;text-decoration: underline;text-align:center;color:blue;">សិទ្ធិ</a>' 
